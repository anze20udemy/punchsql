...
// Za izpis mora biti postavka znotraj obdobja in pa nadure višje od 30 minut, razen če je sobota ali nedelja.
                ...
                if ( dayOfWeek !== 0 && dayOfWeek !== 6 ) {
                    ...
                    else { //sobota in nedelja in pa vsaj ena ura nadure
                        if (dateStart < prihod && dateEnd > odhod && overtimeMS > 3600000) {
            ...
            $('.potdilo').append(`
                                ...
                                ${user}</span><span style="padding-left: 6em;">mesec: <span style="text-transform: uppercase; text-decoration: underline">${monthName}</span></span></p>`);
                getPunchesForExport();
